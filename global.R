  ...
  suppressWarnings({
    .plot <- data %>%
      ...
      geom_rect(aes(xmin = .week, xmax = .week + weeks(1),
                    ymin = 0, ymax = 50),
                fill = "grey", alpha = 3/4) +
      annotate("segment", x = census_2023[[2, 5]], xend = census_2023[[2, 5]], y = 0, yend = 50, colour = "red", alpha = 1/2) +
      annotate("segment", x = census_2023[[3, 5]], xend = census_2023[[3, 5]], y = 0, yend = 50, colour = "red", alpha = 1/2) +
      annotate("segment", x = census_2023[[4, 5]], xend = census_2023[[4, 5]], y = 0, yend = 50, colour = "red", alpha = 1/2) +
      annotate("segment", x = census_2023[[5, 5]], xend = census_2023[[5, 5]], y = 0, yend = 50, colour = "red", alpha = 1/2) +
      annotate("text", x = census_2023[[2, 5]], y = 52, label = str_c("Cierre cap. \n", census_2023[[2, 1]]), size = 2, color = "red") +
      annotate("text", x = census_2023[[3, 5]], y = 52, label = str_c("Cierre cap. \n", census_2023[[3, 1]]), size = 2, color = "red") +
      annotate("text", x = census_2023[[4, 5]], y = 52, label = str_c("Cierre cap. \n", census_2023[[4, 1]]), size = 2, color = "red") +
      annotate("text", x = census_2023[[5, 5]], y = 52, label = str_c("Cierre cap. \n", census_2023[[5, 1]]), size = 2, color = "red") +
...
plot_arrival_questionnaires_grid_census_2023 <- function(data, max_day, .title = "") {
  ...
  .data <- data %>%
    count(Registro, Censo) %>%
    rename(`Cuestionarios enviados a revisión OC` = names(.)[[3]]) %>%
    left_join(census_2023, by = c("Censo" = "name")) %>%
...
plot_questionnaires_firma_sello_week <- function(data, .title = "") {
  ...
  suppressWarnings({
    .plot <- .data %>%
      ...
      annotate("segment", x = census_2023[[2, 5]], xend = census_2023[[2, 5]], y = 0, yend = ymax, colour = "orange", alpha = 1/2) +
      annotate("segment", x = census_2023[[3, 5]], xend = census_2023[[3, 5]], y = 0, yend = ymax, colour = "orange", alpha = 1/2) +
      annotate("segment", x = census_2023[[4, 5]], xend = census_2023[[4, 5]], y = 0, yend = ymax, colour = "orange", alpha = 1/2) +
      annotate("segment", x = census_2023[[5, 5]], xend = census_2023[[5, 5]], y = 0, yend = ymax, colour = "orange", alpha = 1/2) +
      annotate("segment", x = census_2023[[2, 7]], xend = census_2023[[2, 7]], y = 0, yend = ymax, colour = "red", alpha = 1/2) +
      annotate("segment", x = census_2023[[3, 7]], xend = census_2023[[3, 7]], y = 0, yend = ymax, colour = "red", alpha = 1/2) +
      annotate("segment", x = census_2023[[4, 7]], xend = census_2023[[4, 7]], y = 0, yend = ymax, colour = "red", alpha = 1/2) +
      annotate("segment", x = census_2023[[5, 7]], xend = census_2023[[5, 7]], y = 0, yend = ymax, colour = "red", alpha = 1/2) +
      annotate("text", x = census_2023[[2, 5]], y = ymax + 2, label = str_c("Cierre cap. \n", census_2023[[2, 1]]), size = 2, color = "orange") +
      annotate("text", x = census_2023[[3, 5]], y = ymax + 2, label = str_c("Cierre cap. \n", census_2023[[3, 1]]), size = 2, color = "orange") +
      annotate("text", x = census_2023[[4, 5]], y = ymax + 2, label = str_c("Cierre cap. \n", census_2023[[4, 1]]), size = 2, color = "orange") +
      annotate("text", x = census_2023[[5, 5]], y = ymax + 2, label = str_c("Cierre cap. \n", census_2023[[5, 1]]), size = 2, color = "orange") +
      annotate("text", x = census_2023[[2, 7]], y = ymax + 2, label = str_c("Difusión \n", census_2023[[2, 1]]), size = 2, color = "red") +
      annotate("text", x = census_2023[[3, 7]], y = ymax + 2, label = str_c("Difusión \n", census_2023[[3, 1]]), size = 2, color = "red") +
      annotate("text", x = census_2023[[4, 7]], y = ymax + 2, label = str_c("Difusión \n", census_2023[[4, 1]]), size = 2, color = "red") +
      annotate("text", x = census_2023[[5, 7]], y = ymax + 2, label = str_c("Difusión \n", census_2023[[5, 1]]), size = 2, color = "red") +
...
plot_questionnaires_firma_sello_week_project <- function(data, project, .title = "") {
  ...
  .plot <- function(.census) {
    plot <- ggplot(.data, aes(Domingo, `Cuestionarios acumulados en proceso de firma y sello (1)`)) +
      annotate("segment", x = census_2023[[which(census[1] == .census), 5]], xend = census_2023[[which(census[1] == .census), 5]],
               y = 0, yend = ymax, colour = "orange", alpha = 1/2) +
      annotate("segment", x = census_2023[[which(census[1] == .census), 7]], xend = census_2023[[which(census[1] == .census), 7]],
               y = 0, yend = ymax, colour = "red", alpha = 1/2) +
      annotate("text",    x = census_2023[[which(census[1] == .census), 5]], y = ymax + 2,
               label = str_c("Cierre cap. \n", .census), size = 2, color = "orange") +
      annotate("text",    x = census_2023[[which(census[1] == .census), 7]], y = ymax + 2,
...
# Local analysis.
# plot_questionnaires_firma_sello_week_project(database_questionnaires_firma_sello, levels(census_2023[[1]])[1])
...
count_questionnaires_firma_sello <- function(data, .census, .min = pull(census_2023, 2)[3], .max) {
